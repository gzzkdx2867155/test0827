...
def build_model():
   ...
   # model.add(Dropout(0.8))
    model.add(GRU(50,init='lecun_uniform', input_shape=(10,3), return_sequences=True,activation ='sigmoid'))
   ...
   # model.add(LSTM(30,init='uniform', return_sequences=True,activation ='sigmoid'))
    ...
    model.add(GRU(50,init='lecun_uniform',return_sequences=False,activation ='sigmoid'))
...
if __name__ == '__main__':
    ...
    numpy.savetxt('result0827/150000sample50vprediction10to1v1.txt', prediction)