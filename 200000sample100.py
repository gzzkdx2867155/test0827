...
def build_model():
   ...
   # model.add(Dropout(0.8))
    model.add(GRU(100,init='lecun_uniform', input_shape=(10,3), return_sequences=True,activation ='sigmoid'))
...
if __name__ == '__main__':
    ...
    numpy.savetxt('result0827/200000sample100vprediction10to1v1.txt', prediction)