...
def build_model():
    ...
    numpy.random.seed(8)
    model=Sequential()
    #model.add(Dense(100,input_shape=(None,10,3),init='uniform',activation='relu'))
    #model.add(Dense(3, input_shape=(3,)))
    #model.add(Embedding(output_dim=(10,3,), input_dim=3, input_length=10))
    
   # model.add(Dropout(0.8))
    model.add(GRU(10,init='lecun_uniform', input_shape=(10,3), return_sequences=True,activation ='sigmoid'))
   ...
   # model.add(LSTM(30,init='uniform', return_sequences=True,activation ='sigmoid'))
    ...
    model.add(GRU(10,init='lecun_uniform',return_sequences=True,activation ='sigmoid'))
    model.add(GRU(10,init='lecun_uniform',return_sequences=False,activation ='sigmoid'))
...
if __name__ == '__main__':
    ...
    numpy.savetxt('result0827\200000sample101010vprediction10to1v1.txt', prediction)