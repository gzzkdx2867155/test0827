...
def build_model():
   ...
   # model.add(Dropout(0.8))
    model.add(GRU(300,init='lecun_uniform', input_shape=(13,3), return_sequences=True,activation ='sigmoid'))
...
if __name__ == '__main__':
    ...
    min4=0
    max4=28.1513                         
    data=sio.loadmat('trainset13.mat') 
    trainset=data['trainset']
    data1=sio.loadmat('aimset13.mat')
    aimset=data1['aimset']
    ...
    result_file = os.path.join(result_file,'200000samplevprediction13to1.txt')
